...
class DataHandler:
    ...
    def fill_dh(self, sample_path):
        ...
        self.factor_model = FactorModel( 
                    ...
                    labels=labels,
                    pkl_path=None, 
                    cmap=mycmap(data_set))

        self.cmap=mycmap(data_set)
    ...
    def get_mean_pred(self):
        ...
        a = np.reshape(a, [self.factor_model.h, self.factor_model.w, self.factor_model.num_logits])
    ...
    def plot_factors(self):
        #factors = self.factor_model.compute_fac_visualization()
