...
def IoU(sample1, sample2, num_classes=None, dim=None, reduce=True):
    """
    Intersection over Union. For usage as done by Monteiro et al.'s stochastic segmentation
...
def sample_diversity(samples, dist_fcn=IoU, dim=None, num_classes=None):
    ...
    dist_fcn : method           function to be used as a distance meaure
    """
...
def pairwise_seperation_L1(factor_model):
    # n = num_relevant_factors_L1(factor_model=factor_model,
    #                            relevance_level=relevance_level,
    #                            reduce=False,
    #                            use_flow_probs=use_flow_probs)
